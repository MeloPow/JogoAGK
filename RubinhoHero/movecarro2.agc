...
angle1= GetSpriteAngle (1)-11.249985														//Ângulo de movimentação do carro pra cima
angle2= GetSpriteAngle (1)-17.99999															//Ângulo de movimentação do carro pra esquerda
angle4= GetSpriteAngle (1)-11.249992829														//Ângulo de movimentação do carro pra baixo		
angle3= GetSpriteAngle (1)-9																//Ângulo de movimentação do carro pra direita


if GetSpriteY (1) >= 526 and GetSpriteX (1) < 1100 and GetSpriteX (1) > 145					//Movimentação da parte de baixo pra direita
carrox=GetSpriteX(1)+7
carroy=526
endif

if GetSpriteX(1) > 1050 and GetSpriteX (1) < 1100											//Movimentação do lado direito pra cima
carrox=1070
carroy=GetSpriteY(1)-7
endif
...
if GetSpriteY (1) > 166 and GetSpriteY (1) < 230 and GetSpriteX (1) = 1070			 		//Condição de Angulação do carro para esquerda
